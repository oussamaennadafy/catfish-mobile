...
mixin _$User {
  ...
  bool get firstTimeOpen => throw _privateConstructorUsedError;
...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String firstName, String lastName, String token, bool firstTimeOpen});
}
    ...
    return _then(_value.copyWith(
      ...
      token: null == token
          ...
          : token // ignore: cast_nullable_to_non_nullable
              as String,
      firstTimeOpen: null == firstTimeOpen
          ? _value.firstTimeOpen
          : firstTimeOpen // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$UserImpl implements _User {
  const _$UserImpl({required this.firstName, required this.lastName, required this.token, required this.firstTimeOpen});
  ...
  @override
  String toString() {
    return 'User(firstName: $firstName, lastName: $lastName, token: $token, firstTimeOpen: $firstTimeOpen)';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType && other is _$UserImpl && (identical(other.firstName, firstName) || other.firstName == firstName) && (identical(other.lastName, lastName) || other.lastName == lastName) && (identical(other.token, token) || other.token == token) && (identical(other.firstTimeOpen, firstTimeOpen) || other.firstTimeOpen == firstTimeOpen));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, firstName, lastName, token, firstTimeOpen);
...
abstract class _User implements User {
  const factory _User({required final String firstName, required final String lastName, required final String token, required final bool firstTimeOpen}) = _$UserImpl;
